  ...
  return (
    <section className="relative pt-20 overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        <div className="absolute -top-20 -left-20 w-80 h-80 bg-thynk-50 rounded-full filter blur-3xl opacity-30" />
      </div>
        ...
        <div className="space-y-8 animate-fade-up">
          <div className="space-y-2">
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold tracking-tight text-balance">
              Your Global Education Journey <span className="text-gradient">Starts Here</span>
            </h1>
            <p className="text-xl text-gray-600 pt-4 max-w-xl">
              Transforming uncertainty into clarity with personalized pathways to your dream university abroad.
            </p>
          </div>

          <div className="flex flex-wrap gap-4 pt-2">
            <Button size="lg" className="bg-thynk-600 hover:bg-thynk-700 text-white transition">
              Book a Consultation
              <ArrowRight className="ml-2 h-4 w-4" />
            </Button>
            <Button size="lg" variant="outline" className="border-thynk-200 text-thynk-800 hover:bg-thynk-50">
          ...
          <div className="flex flex-wrap gap-6 pt-6">
            {['USA', 'UK', 'Canada', 'Australia', 'Germany'].map((country) => (
              <div key={country} className="flex items-center gap-2">
                <CheckCircle className="h-5 w-5 text-thynk-600" />
          ...
          <div className="bg-white rounded-xl p-6 sm:p-8">
            {step === 0 && (
              <div className="space-y-6">
                <div className="text-center mb-8">
                  ...
                  <p className="text-gray-600 mt-2">Get instant matches in just 45 seconds</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <Button 
                    type="submit" 
                    className="w-full bg-thynk-600 hover:bg-thynk-700 text-white py-6 rounded-lg transition-colors"
                  >
                    Check Eligibility
            ...
            {step === 1 && (
              <div className="animate-scale-in">
                <div className="text-center mb-8">
                  <h2 className="text-2xl font-bold text-gray-900">Your Eligibility Results</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-4">
                    <h3 className="font-semibold text-gray-900">Top University Matches</h3>
                    ...
                    {[
                      ...
                      <div key={index} className="flex items-center justify-between p-4 border border-gray-100 rounded-lg hover:bg-gray-50 transition-colors">
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <span className="px-2 py-1 bg-thynk-100 text-thynk-800 rounded-md font-medium text-sm">
                            {uni.match}%
                          </span>
                        </div>
                      </div>
                  ...
                  <div className="pt-4">
                    <Button
                      onClick={() => setStep(2)} 
                      className="w-full bg-thynk-600 hover:bg-thynk-700 text-white py-3 rounded-lg transition-colors"
                    >
            ...
            {step === 2 && (
              <div className="animate-scale-in">
                <div className="text-center mb-8">
                  <h2 className="text-2xl font-bold text-gray-900">Save Your Results</h2>
                ...
                <form className="space-y-4">
                  ...
                  <div className="text-center pt-4">
                    <Button variant="link" className="text-thynk-600" onClick={() => setStep(0)}>
                      Start over
                    </Button>
                  </div>
                </form>
      ...
      <div className="section-container pt-16 pb-8">
        <p className="text-center text-sm text-gray-500 uppercase tracking-wider mb-8">Trusted by students accepted to</p>
        <div className="flex flex-wrap justify-center gap-12 opacity-70">
          {['Harvard', 'Stanford', 'MIT', 'Oxford', 'Cambridge', 'ETH Zurich'].map((uni) => (
            <div key={uni} className="text-xl font-serif font-medium text-gray-800">
              {uni}
            </div>
          ))}
        </div>
