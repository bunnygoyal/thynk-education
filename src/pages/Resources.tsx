...
const Resources = () => {
  return (
    <PageTemplate
      title="Resources"
      description="Access our comprehensive collection of resources designed to help you navigate the study abroad journey. From application guides to visa preparation, we've got you covered."
    >
