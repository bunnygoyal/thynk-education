...
const Programs = () => {
  ...
  return (
    <PageTemplate
      ...
      description="Discover a wide range of academic programs available at universities around the world. Use the filters below to find programs that match your interests and career goals."
    >
